...
function Profile_preview({ user, profilepic, profilecover }) {
      ...
      <div className="profile_preview_banner">
        ...
        <div className="profile_preview_image_info">
          ...
          <div className="profile_job_web">
            ...
            {storedUserId != id ? <button>Follow</button> : ""}
          ...
          <div className="profile_posts">
            ...
            {posts.length > 0 &&
              posts.map((post) => <Profile_post_card key={post._id} {...post} ></Profile_post_card>)}
          </div>
        </div>
      </div>
    </div>
